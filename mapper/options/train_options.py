...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--lpips_lambda', default=0.7, type=float, help='LPIPS loss multiplier factor')
        self.parser.add_argument('--id_lambda', default=1.6, type=float, help='ID loss multiplier factor')
        ...
        self.parser.add_argument('--l2_lambda', default=0.5, type=float, help='L2 pixel loss multiplier factor')
        self.parser.add_argument('--l2w_lambda', default=0.000002, type=float, help='L2 W loss multiplier factor')
        ...
        self.parser.add_argument('--checkpoint_path', default="./exp_12/checkpoints/iteration_30000.pt", type=str, help='Path to StyleCLIPModel model checkpoint')

        self.parser.add_argument('--max_steps', default=20000, type=int, help='Maximum number of training steps')
